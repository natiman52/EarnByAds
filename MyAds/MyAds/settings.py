...
SECRET_KEY = 'django-insecure-_o#$zek3fn6#f41%do18bo3p_hm$^wvr3zy2dsb!v7tt(o-v#m'
...
TEMPLATES = [
    {
        ...
        'DIRS': [Path.joinpath(BASE_DIR,"tempates")],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'MyAds.wsgi.application'
